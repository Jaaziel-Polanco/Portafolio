...
const WORDS = ["Software and AI Student", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Next.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Jaaziel-Polanco" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/jaaziel-sebasti%C3%A1n-polanco-martinez-63a851288/" },
  { icon: Instagram, link: "https://www.instagram.com/jaaziel_polanco/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Diseño, desarrollo e innovación: llevando tus proyectos al siguiente nivel...
                </p>
